...
from multimodal_retriever_bllip import MultimodalRetriever
...
def main():
    ...
    Mretriever = MultimodalRetriever(device=device,use_blip=True)
    ...
    entity_cache_path = f"entity_cache_CLIP2_{divide_modal}_{str(image_type)}.json"
    ...
    with open("../datasets/all_triple_embeddings_clip2.pkl", "rb") as f:
    ...
    # 日志文件路径
    log_path = f"./results/log_{current_time}_CLIP2_{divide_modal}_{model_name}_image_{str(image_type)}.txt"
