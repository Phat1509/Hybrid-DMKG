...
def main():
    ...
    # 日志文件路径
    log_path = f"./results/log_{current_time}_CLIP2_no_LLMs_{model_name}_{divide_modal}_{args.information_type}_image_{str(image_type)}.txt"
                        ...
                        for index_sub, subq in enumerate(sub_questions):
                            ...
                            if "[IMAGE]" in subq:
                                ...
                                if cache_key in entity_cache:
                                    ...
                                    input_query_embedding = Mretriever.encode_queries(input_query, information_type=args.information_type, have_image=True)
