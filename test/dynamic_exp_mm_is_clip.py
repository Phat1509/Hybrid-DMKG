...
def main():
    ...
    entity_cache_path = f"entity_cache_CLIP2_{divide_modal}_information_type_{args.information_type}_{str(image_type)}.json"
    ...
    # 日志文件路径
    log_path = f"./results/log_{current_time}_CLIP2_{divide_modal}_{model_name}_information_type_{args.information_type}_image_{str(image_type)}.txt"
    ...
    end_time = time.time()
    print(f"Total time: {end_time - start_time} 10 seconds")
