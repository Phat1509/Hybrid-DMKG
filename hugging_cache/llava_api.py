...
def model_answer():
    ...
    # print(f"Image Path: {image_path}, Question: {question}")  # 打印调试信息
    ...
    # print(f"Raw Answer: {answer_final}")
...
if __name__ == '__main__':
    ...
    port = args.port or int(os.environ.get("PORT", 5008))
    app.run(host='0.0.0.0', port=port , debug=False)   # 支持修改bug，保存文件之后重启
